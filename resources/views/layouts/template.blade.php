...
<head>
    ...
    <style>
        ...
        .sidebar {
            border-right: 1px solid #ccc; /* Add a border to the right side of the sidebar */
            padding-right: 15px; /* Optional: Adjust padding to separate content from the border */
        }
    </style>    
    @yield('styles')
