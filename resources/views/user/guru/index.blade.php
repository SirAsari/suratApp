...
<a href="{{ route('user.guru.create') }}"><button class="btn btn-success mb-4">Tambah Data</button></a>
<div class="d-flex justify-content-start mb-3">
    <form method="GET" action="{{ route('user.guru.index') }}" class="d-flex">
...
<div class="d-flex justify-content-start mb-3">
    <form method="GET" action="{{ route('user.guru.index') }}">
